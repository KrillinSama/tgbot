...
from axel_kassemsyr import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from axel_kassemsyr.modules import ALL_MODULES
from axel_kassemsyr.modules.helper_funcs.chat_status import is_user_admin
from axel_kassemsyr.modules.helper_funcs.misc import paginate_modules
...
SOURCE_STRING = """
I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find my source code [here](https://github.com/KassemSYR/tgbot)
"""
...
A few handy commands are:
 ...
 - /source: gives you my sourcecode on github.
 
{}
""".format("" if not ALLOW_EXCL else "\n `All commands can be used with the following: / !` \n")

DONATE_STRING = """Cool, I'm glad to hear this! \
You can donate my crurrent developer via [PayPal](paypal.me/KassemSYRKanaan) ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("axel_kassemsyr.modules." + module_name)
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        update.effective_message.reply_text("You can also donate to the other contributors, via Paypal [corsicanu](http://paypal.me/corsicanu), & [nunopenim](http://paypal.me/nunopenim).",
                                                parse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True)
