...
from axel_kassemsyr import dispatcher, BAN_STICKER
from axel_kassemsyr.modules.disable import DisableAbleCommandHandler
from axel_kassemsyr.modules.helper_funcs.chat_status import is_user_admin, bot_admin, user_admin_no_reply, user_admin, \
    can_restrict
from axel_kassemsyr.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
...
from axel_kassemsyr.modules.helper_funcs.string_handling import split_quotes
from axel_kassemsyr.modules.log_channel import loggable
from axel_kassemsyr.modules.sql import warns_sql as sql
...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # axel ban sticker
        keyboard = []
        log_reason = "<b>{}:</b>" \
                     "\n#WARN_BAN" \
                     "\n<b>Admin:</b> {}" \
