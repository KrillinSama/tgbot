...
from axel_kassemsyr import dispatcher, SUDO_USERS, OWNER_USERNAME, OWNER_ID
from axel_kassemsyr.modules.helper_funcs.extraction import extract_user
from axel_kassemsyr.modules.helper_funcs.chat_status import bot_admin
...
SUDOPROMOTE_HANDLER = CommandHandler("supromote", sudopromote, pass_args=True, filters=Filters.user(OWNER_ID))
SUDODEMOTE_HANDLER = CommandHandler("sudemote", sudodemote, pass_args=True, filters=Filters.user(OWNER_ID))
