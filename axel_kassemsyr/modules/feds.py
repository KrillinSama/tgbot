...
from axel_kassemsyr import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from axel_kassemsyr.modules.helper_funcs.handlers import CMD_STARTERS
from axel_kassemsyr.modules.helper_funcs.misc import is_module_loaded, send_to_list
from axel_kassemsyr.modules.helper_funcs.chat_status import is_user_admin
from axel_kassemsyr.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from axel_kassemsyr.modules.helper_funcs.string_handling import markdown_parser
from axel_kassemsyr.modules.disable import DisableAbleCommandHandler

import axel_kassemsyr.modules.sql.feds_sql as sql
...
def new_fed(bot: Bot, update: Update):
	...
	if not fednam == '':
		...
		if not x:
			update.effective_message.reply_text("Federation creation failed! ")
			return
